...
export interface SoundNFTFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "ARTIST_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "deployedAlbums",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface SoundNFTFactory extends BaseContract {
  connect(runner?: ContractRunner | null): SoundNFTFactory;
  waitForDeployment(): Promise<this>;

  interface: SoundNFTFactoryInterface;
  ...
  deployedAlbums: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "deployedAlbums"
